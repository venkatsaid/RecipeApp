        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.id_text), withText("1.Recipe Introduction"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("1.Recipe Introduction")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.id_text), withText("1.Recipe Introduction"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("1.Recipe Introduction")));
        ...
        ViewInteraction textView9 = onView(
                allOf(withId(R.id.title), withText("Add to widget"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView9.check(matches(withText("Add to widget")));
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            e.printStackTrace();
